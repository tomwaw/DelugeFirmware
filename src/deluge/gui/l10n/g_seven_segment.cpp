...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_GENERATOR, "GEN"},
        {STRING_FOR_TB3PO, "TB3P"},
        {STRING_FOR_TB3PO_SEED, "SEED"},
        {STRING_FOR_TB3PO_NEW_PATTERN, "NEW"},
        {STRING_FOR_TB3PO_DENSITY, "DENS"},
        {STRING_FOR_TB3PO_LENGTH, "LEN"},
        {STRING_FOR_TB3PO_REGISTER, "REG"},
        {STRING_FOR_TB3PO_SLIDES, "SLID"},
        {STRING_FOR_TB3PO_PENDING, "PEND"},
        {STRING_FOR_TB3PO_PAUSED, "PAUS"},
        {STRING_FOR_TB3PO_ARP_OFF, "ARP OFF"},
        {STRING_FOR_TB3PO_FORWARD, "FWD"},
        {STRING_FOR_TB3PO_NEXT_CYCLE, "PEND"},
        {STRING_FOR_TB3PO_FREEZE, "FRZE"},
        {STRING_FOR_TB3PO_WAIT_BAR, "WAIT"},
        {STRING_FOR_TB3PO_SESSION_ONLY, "SONG"},
        {STRING_FOR_TB3PO_FROZEN, "DONE"},
        {STRING_FOR_GRIDS, "GRID"},
        {STRING_FOR_GRIDS_X, "X"},
        {STRING_FOR_GRIDS_Y, "Y"},
        {STRING_FOR_GRIDS_KICK, "KICK"},
        {STRING_FOR_GRIDS_SNARE, "SNAR"},
        {STRING_FOR_GRIDS_HAT, "HAT"},
        {STRING_FOR_GRIDS_CHAOS, "CHAOS"},
        {STRING_FOR_GRIDS_SEED, "SEED"},
        {STRING_FOR_GRIDS_NEW_SEED, "NEW"},
        {STRING_FOR_GRIDS_PAUSED, "PAUS"},
        {STRING_FOR_GRIDS_PENDING, "PEND"},
        {STRING_FOR_GRIDS_UNSUPPORTED, "MODE"},
        {STRING_FOR_GRIDS_DUPLICATE, "USED"},
        {STRING_FOR_GRIDS_UNASSIGNED, "NONE"},
        {STRING_FOR_GRIDS_KICK_ROW, "KIRW"},
        {STRING_FOR_GRIDS_KICK_NOTE, "KINT"},
        {STRING_FOR_GRIDS_SNARE_ROW, "SNRW"},
