...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_GENERATOR, "Generator"},
        {STRING_FOR_TB3PO, "TB3PO"},
        {STRING_FOR_TB3PO_SEED, "Seed"},
        {STRING_FOR_TB3PO_NEW_PATTERN, "New pattern"},
        {STRING_FOR_TB3PO_DENSITY, "Density"},
        {STRING_FOR_TB3PO_LENGTH, "Length"},
        {STRING_FOR_TB3PO_REGISTER, "Register"},
        {STRING_FOR_TB3PO_SLIDES, "Slides"},
        {STRING_FOR_TB3PO_PENDING, "TB3PO pending"},
        {STRING_FOR_TB3PO_PAUSED, "TB3PO paused"},
        {STRING_FOR_TB3PO_ARP_OFF, "Turn arp off"},
        {STRING_FOR_TB3PO_FORWARD, "Use forward direction"},
        {STRING_FOR_TB3PO_NEXT_CYCLE, "Next cycle"},
        {STRING_FOR_TB3PO_FREEZE, "Freeze last bar"},
        {STRING_FOR_TB3PO_WAIT_BAR, "Play a full bar"},
        {STRING_FOR_TB3PO_SESSION_ONLY, "Use Session clip"},
        {STRING_FOR_TB3PO_FROZEN, "Frozen in clip"},
        {STRING_FOR_GRIDS, "Grids"},
        {STRING_FOR_GRIDS_X, "Map X"},
        {STRING_FOR_GRIDS_Y, "Map Y"},
        {STRING_FOR_GRIDS_KICK, "Kick density"},
        {STRING_FOR_GRIDS_SNARE, "Snare density"},
        {STRING_FOR_GRIDS_HAT, "Hat density"},
        {STRING_FOR_GRIDS_CHAOS, "Chaos"},
        {STRING_FOR_GRIDS_SEED, "Seed"},
        {STRING_FOR_GRIDS_NEW_SEED, "New seed"},
        {STRING_FOR_GRIDS_PAUSED, "Grids paused"},
        {STRING_FOR_GRIDS_PENDING, "Grids: seed pending"},
        {STRING_FOR_GRIDS_UNSUPPORTED, "Use Forward, arp off, sound rows"},
        {STRING_FOR_GRIDS_DUPLICATE, "Destination already assigned"},
        {STRING_FOR_GRIDS_UNASSIGNED, "Unassigned"},
        {STRING_FOR_GRIDS_KICK_ROW, "Kick row"},
        {STRING_FOR_GRIDS_KICK_NOTE, "Kick note"},
        {STRING_FOR_GRIDS_SNARE_ROW, "Snare row"},
